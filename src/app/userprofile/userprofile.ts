...
export class Userprofile {
  ...
  users = [
    ...
    // },
    {
      ...
      image: 'images/me.jpg',
      description:
        'Conduct various types of testing like functional, performance, regression, and UAT (User Acceptance Testing).',
    ...
    },
    {
      ...
      description:
        'Design and develop frontend user interfaces using modern frameworks.',
    ...
    },
    {
      ...
      role: 'Data Engineer',
      description:
        'Work with large-scale datasets from multiple sources (databases, APIs, logs, etc.).',
    ...
    },
    {
      ...
      image: 'images/me.jpg',
      description:
        'Passionate developer learning Angular and building modern web apps.',
